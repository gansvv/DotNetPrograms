...
namespace DotNetPrograms.Tree
{
    ...
    class ConstructTreeInorderLevelOrder
    {
        public Node root;
        ...
        public virtual Node ConstructTree(Node startNode, int[] levelOrder, int[] inOrder, int inStart, int inEnd)
        {
        ...
        {
            ConstructTreeInorderLevelOrder tree = new();
            ...
            Console.Write("Inorder traversal of the constructed tree is \n");
